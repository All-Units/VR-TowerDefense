...
namespace UnitySimpleLiquid
{
    ...
    public class LiquidContainer : MonoBehaviour
    {
        ...
        public bool RefillOnEmpty = false;
        ...
        private void Update()
        {
            ...
            if (RefillOnEmpty && fillAmountPercent <= 0)
                fillAmountPercent = 0.95f;
        }
        ...
        public void _OnStartTilt()
        {
            _IsTilting = true;
            _OnChangeState();
        }
        public void _OnEndTilt()
        {
            _IsTilting = false;
            _OnChangeState();
        }
        bool _hasCap = true;
        public void _OnPlaceCap()
        {
            _hasCap = true;
            _OnChangeState();
        }
        public void _OnRemoveCap()
        {
            _hasCap = false;
            _OnChangeState();
        }
